...
#include <linux/fs.h>
extern int reset_page_counter_in_ns(struct page* page);
struct mempolicy;
struct anon_vma;
...
#define VM_NCACHE	0x200000000
#define VM_ISOLATION	0x100000000
#define VM_CACHE_UC_MINUS 0x400000000
#define VM_CACHE_UC 0x800000000
